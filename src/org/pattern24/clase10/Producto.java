...
//    }
    ...
    @Override
    public Bebida aplicarCalificacion(int estrellas) {
        Calificacion calificacion = (estrellas >= 0 && estrellas <= 5) ? Calificacion.values()[estrellas] : CALIFICACION_POR_DEFECTO;
